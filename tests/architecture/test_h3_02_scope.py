...
def test_h3_02_is_provider_neutral_and_excludes_later_slices() -> None:
    ...
    for later_context in ("documents", "knowledge", "workflows", "notifications"):
...
def test_h3_01_scope_now_defers_jobs_to_h3_02_without_changing_resource_graph() -> None:
    h3_01 = (ROOT / "tests" / "architecture" / "test_h3_01_scope.py").read_text()
    assert 'later_context in ("documents", "knowledge", "workflows")' in h3_01
