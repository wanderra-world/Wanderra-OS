...
H2-01 through H2-03 accepted; H2-04 implemented pending pull-request acceptance
...
### Phase 2 — H1 and H2-01 through H2-03 accepted; H2-04 implementation review
...
[H2_PLATFORM_SPEC.md](H2_PLATFORM_SPEC.md). H2-01 through H2-03 are accepted and
merged. H2-04 is implemented on its dedicated branch with evidence in
[H2_04_ACCEPTANCE_EVIDENCE.md](H2_04_ACCEPTANCE_EVIDENCE.md). H2-05 and later slices
...
This specification is accepted. H2-01 through H2-03 are accepted and merged; H2-04
...
Review and merge the dedicated H2-04 pull request after all mandatory checks pass.
Do not begin H2-05 before H2-04 is explicitly accepted and merged.
