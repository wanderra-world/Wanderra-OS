...
H2-01 through H2-06 accepted; H2-07 implemented pending pull-request acceptance
...
### Phase 2 — H1 and H2-01 through H2-06 accepted; H2-07 implementation review
...
[H2_PLATFORM_SPEC.md](H2_PLATFORM_SPEC.md). H2-01 through H2-06 are accepted and
merged. H2-07 is implemented on its dedicated branch with evidence in
[H2_07_ACCEPTANCE_EVIDENCE.md](H2_07_ACCEPTANCE_EVIDENCE.md). H2-08 and later slices
...
Review and merge the dedicated H2-07 pull request after all mandatory checks pass.
Do not begin H2-08 before H2-07 is explicitly accepted and merged.
