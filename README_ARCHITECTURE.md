...
The H1 decomposition is accepted. H1-04 is merged. H1-05 implements the deterministic
fixed-role authorization boundary on a review branch without changing Phase 1 request
behavior.
...
Review and accept the H1-05 pull request. H1-06 is not authorized and no subsequent H1
